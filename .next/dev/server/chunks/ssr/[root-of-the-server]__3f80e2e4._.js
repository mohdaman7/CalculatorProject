...
"[project]/calculator-pwa/src/lib/api/services/CalculatorService.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$BaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/calculator-pwa/src/lib/api/services/BaseService.js [app-ssr] (ecmascript)");
;
class CalculatorService extends __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$BaseService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"] {
    constructor(){
        super('/calculator');
    }
...
"[project]/calculator-pwa/src/lib/api/index.js [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$CalculatorService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/calculator-pwa/src/lib/api/services/CalculatorService.js [app-ssr] (ecmascript)");
...
"[project]/calculator-pwa/src/lib/api/services/AuthService.js [app-ssr] (ecmascript) <export default as authService>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "authService",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"]
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/calculator-pwa/src/lib/api/services/AuthService.js [app-ssr] (ecmascript)");
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/calculator-pwa/src/lib/api/index.js [app-ssr] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__ = __turbopack_context__.i("[project]/calculator-pwa/src/lib/api/services/AuthService.js [app-ssr] (ecmascript) <export default as authService>");
"use client";
;
;
;
...
function AuthProvider({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const initAuth = async ()=>{
            if (__TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__["authService"].isAuthenticated()) {
                try {
                    const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__["authService"].getCurrentUser();
                    setUser(data.user);
                } catch (error) {
                    console.error('Failed to get current user:', error);
                    __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__["authService"].logout();
                }
            }
            setLoading(false);
        };
    ...
    const login = async (email, password)=>{
        try {
            setError(null);
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__["authService"].login({
                email,
                password
            });
            setUser(data.user);
    ...
    const register = async (username, email, password)=>{
        try {
            setError(null);
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__["authService"].register({
                username,
                email,
                password
            });
    ...
    const updateForcedNumber = async (forcedNumbers)=>{
        try {
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$src$2f$lib$2f$api$2f$services$2f$AuthService$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__authService$3e$__["authService"].updateForcedNumber(forcedNumbers);
            setUser((prev)=>({
                    ...prev,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f80e2e4._.js.map