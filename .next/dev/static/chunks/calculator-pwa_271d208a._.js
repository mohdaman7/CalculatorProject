...
function AuthProvider({ children }) {
    ...
    const updateForcedNumber = async (forcedNumber)=>{
        try {
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].updateForcedNumber(forcedNumber);
            setUser((prev)=>({
                    ...prev,
...
function Home() {
    ...
    const { user, isAuthenticated, updateForcedNumber } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$contexts$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"])();
...
_s(Home, "FlB6YSHi5Clgh/DEjLf/bRPG9/E=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$contexts$2f$AuthContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"]
    ];
});
...
//# sourceMappingURL=calculator-pwa_271d208a._.js.map