...
function AuthProvider({ children }) {
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const initAuth = {
                "AuthProvider.useEffect.initAuth": async ()=>{
                    if (__TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].isAuthenticated()) {
                        try {
                            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].getCurrentUser();
                            setUser(data.user);
                        } catch (error) {
                            console.error('Failed to get current user:', error);
                            __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].logout();
                        }
                    }
                    setLoading(false);
                }
    ...
    const login = async (email, password)=>{
        try {
            setError(null);
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].login({
                email,
                password
            });
            setUser(data.user);
    ...
    const register = async (username, email, password)=>{
        try {
            setError(null);
            setLoading(true);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].register({
                username,
                email,
                password
            });
    ...
    const updateForcedNumber = async (forcedNumbers)=>{
        try {
            setError(null);
            const data = await __TURBOPACK__imported__module__$5b$project$5d2f$calculator$2d$pwa$2f$lib$2f$api$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiService"].updateForcedNumber(forcedNumbers);
            setUser((prev)=>({
                    ...prev,
